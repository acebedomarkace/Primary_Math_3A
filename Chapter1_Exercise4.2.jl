...
md""" **(a)**
$(@bind a1 html"<input type=text >") is 10 more than 385
"""
...
begin
	function checker_a1(ans)
		if ("395")==ans || ("three hundred ninety five")==lowercase(ans)
			print("👍 That's correct!")
			return 1
		elseif isempty(ans)
			print("😀 The Box is empty! Type in your answer")
			return ""
		elseif !isempty(ans) && ("395")!=ans && ("three hundred ninety five")!=lowercase(ans)
			print("🧐 So you're typing... Keep going! and...")
			return ""
		else
...
md""" **(b)**
$(@bind b1 html"<input type=text >") is 10 less than 600.
"""
...
begin
	function checker_b1(ans)
		if ("590")==ans || ("five hundred ninety")==lowercase(ans)
			print("👍 That's correct!")
			return 1
		elseif isempty(ans)
			print("😀 The Box is empty! Type in your answer")
...
md""" **(c)**
$(@bind c1 html"<input type=text >") is 100 more than 3924
"""
...
begin
	function checker_c1(ans)
		if ("4024")==ans || ("4,024")==ans || ("four thousand twenty four")==lowercase(ans)
			print("👍 That's correct!")
			return 1
		elseif ("")==ans
...
md""" **(d)**
$(@bind d1 html"<input type=text >") is 1000 less than 4507.
"""
...
begin
	function checker_d1(ans)
		if ("3507")==ans || ("3,507")==ans || ("three thousand five hundred seven")==lowercase(ans)
			print("👍 That's correct!")
			return 1
		elseif isempty(ans)
			print("😀 Waiting for your answer")
...
md""" **(e)**
1083 + 100 = $(@bind e1 html"<input type=text >")
"""
...
md""" **(f)**
2316 + 400 = $(@bind f1 html"<input type=text >")
"""
...
begin
	function checker_f1(ans)
		if ("2716")==ans || ("2,716")==ans || ("two thousand seven hundred sixteen")==lowercase(ans)
			print("👍 That's correct!")
			return 1
		elseif ("")==ans
...
md""" **(g)**
1325 - 100 = $(@bind g1 html"<input type=text >")
"""
...
begin
	function checker_g1(ans)
		if ("1225")==ans || ("1,225")==ans || ("one thousand two hundred twenty five")==lowercase(ans)
			print("👍 That's correct!")
			return 1
		elseif ("")==ans
			print("😀 Type in your answer in the empty box.")
...
md""" **(h)**
4917 - 200 = $(@bind h1 html"<input type=text >")
"""
...
begin
	function checker_h1(ans)
		if ("4717")==ans || ("4,717")==ans || ("four thousand seven hundred seventeen")==lowercase(ans)
			print("👍 That's correct!")
			return 1
		elseif ("")==ans
			print("😀 Type in your answer in the empty box.")
